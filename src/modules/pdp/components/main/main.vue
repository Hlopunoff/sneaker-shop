<template>
  <main :class="b()">
    <app-pdp-gallery :class="b('gallery')" :view="galleryView" :slides="product.gallery"/>
    <div :class="b('section')">
      ...
      <div :class="b('info-list')">
        <template v-for="(item, index) in product.productInfo" :key="index" >
          <app-pdp-info v-if="item.details" :class="b('info')" :title="item.title">
...
<style scoped src="./main.style.scss" lang="scss"></style>